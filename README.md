...
| [`generate-doc`](./skills/generate-doc/SKILL.md) | Generate branded FSH client documents (implementation contracts, technical specs) as a final PDF + editable DOCX from Markdown, via a **self-contained bundled renderer** (no repo dependency). Ships starter templates; handles § numbering, lettered sub-lists, and embedded mockups. |
