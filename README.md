...
| [`generate-doc`](./skills/generate-doc/SKILL.md) | Generate branded FSH client documents (implementation contracts, technical specs) as a final PDF + editable DOCX from Markdown, via the monorepo's `render-doc` CLI. Bundles starter templates; handles § numbering, lettered sub-lists, and embedded mockups. |
